...
const Sidebar = () => {
  return (
    <div>
      <img src="https://media-exp3.licdn.com/dms/image/D4D35AQGvcwdSh_s6PA/profile-framedphoto-shrink_200_200/0/1623563518076?e=1623668400&v=beta&t=MhXGtZI-dHFJ496A7rH9jK8daXCKZteHXu-R0Yee2Hk" alt="user avatar" className="w-32 h-32 mx-auto rounded-full" />
      ...
      <button className="w-8/12 px-5 py-2 my-2 text-white rounded-full bg-gradient-to-r from-blue-400 to-pink-400 focus:outline-none">Toggle Theme</button>
    </div>
  )
}
